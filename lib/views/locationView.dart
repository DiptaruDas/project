...
import 'package:brew_crew/map/requests/google_maps_requests.dart';
...
class _MapState extends State<Map> {
  ...
  void createRout(String encodedPoly) {
    setState(() {
      _polyLines.add(
        Polyline(
            polylineId: PolylineId(_lastPosition.toString()),
            width: 10,
            points: convertToLatLang(decodePoly(encodedPoly)),
            color: Colors.black),
      );
    });
  }

//this mathod convert list of double intto latLang
